...
using System.Text;
using System.Data; 
using PCDDBusiness.Common;
using PCDDBusiness.Manage;
using PCDDDAL.Manage;
using PCDDEntity;
using PCDDEntity.Manage;
using PCDDEnum; 

namespace PCDDBusiness
{
    public class M_UsersBusiness
    {
        ...
        {
            pwd = PCDDBusiness.Encrypt.GetEncryptPwd(pwd, loginname);
...
a.BHeight,a.Levelid,a.BWeight,a.MyContent,a.MyCharacter,a.BPay,a.Account,a.TalkTo,a.Description";
        ...
        public static string CreateM_User(M_Users musers)
        {
            ...
            musers.LoginPWD = PCDDBusiness.Encrypt.GetEncryptPwd(musers.LoginPWD, musers.LoginName);
        ...
        {
            string userid = Guid.NewGuid().ToString();
            string userPwd = PCDDBusiness.Encrypt.GetEncryptPwd(loginpwd, loginname);
