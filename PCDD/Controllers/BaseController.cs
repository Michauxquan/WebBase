...
namespace PCDD.Controllers
{
    public class BaseController : Controller
    {
        ...
        protected PCDDEntity.Manage.M_Users CurrentUser
        {
            get
            {
                ...
                {
                    return (PCDDEntity.Manage.M_Users)Session["Manager"];
                }
            }
        ...
        public  bool IsLimits(string menucode)
        {
            if (Session["Manager"] != null)
            {
                PCDDEntity.Manage.M_Users model = (PCDDEntity.Manage.M_Users)Session["Manager"];
